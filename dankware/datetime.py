...
def get_duration(
    then: datetime, now: datetime = None, interval: str = "default"
) -> int | str:
    """
    ...
    raise ValueError(
        f"Invalid Interval: {interval} | Valid Intervals: year, month, week, day, hour, minute, second, dynamic, dynamic-mini, default, default-mini"
    )
